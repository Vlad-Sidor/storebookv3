...
const itemLabels: Record<ItemKey, string> = {
  item1: 'Борхес Х.Л. Неизданная версия рассказа "Вавилонская библиотека"',
  item2: 'Доклад Попова С.В. «Обустройство как эманация Духа»',
  item3: 'Материалы диспутов на тему «Обустройства»',
  item4: 'Письмо царя Филиппа Аристотелю',
  item5: 'Гермес "Превращения"',
          ...
          <form ref={formRef2} onSubmit={handleSubmitCheckbox}>
              <Content>
                <Column>
                  ...
                  <CheckboxList>
                    {(['item1', 'item2', 'item3', 'item4', 'item5'] as ItemKey[]).map((key) => (
                ...
                <Column>
                  ...
                  <CheckboxList>
                    {(['item6', 'item7'] as ItemKey[]).map((key) => (
                      <CheckboxLabel key={key} isChecked={checkedItems[key]}>
                        <Checkbox
                          type="checkbox"
                          checked={checkedItems[key]}
